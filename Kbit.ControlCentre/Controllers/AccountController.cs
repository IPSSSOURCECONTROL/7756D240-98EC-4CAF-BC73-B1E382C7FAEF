        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    KhanyisaIntel.Kbit.Framework.Security.Domain.User.User user =
                        this.UserRepository.GetAll().FirstOrDefault(x => x.Email == model.Email);
                    this.Session[SessionConstants.CurrentUser] = user;
                    this.Session[SessionConstants.CurrentUserBusinessId] = user.BusinessId;
                    this.Session[SessionConstants.CurrentUserRole] = user.Role.GetType().Name;
                    this.Session[SessionConstants.CurrentUserName] = user.Name;
