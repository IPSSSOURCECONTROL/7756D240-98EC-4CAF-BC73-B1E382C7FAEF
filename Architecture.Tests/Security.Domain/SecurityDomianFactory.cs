...
namespace Architecture.Tests.Security.Domain
{
    public class SecurityDomianFactory
    {
        ...
        /// </summary>
        /// <param name="createUserParameters">All properties need to create a valid <see cref="Architecture.Tests.Security.Domain.User.User"/></param>
        /// <returns>A <see cref="Architecture.Tests.Security.Domain.User.User"/></returns>
