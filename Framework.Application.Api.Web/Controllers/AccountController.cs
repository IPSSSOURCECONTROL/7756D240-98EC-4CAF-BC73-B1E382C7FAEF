...
using Framework.Application.Api.Web.Providers;
using Framework.Application.Api.Web.Results;
...
namespace Framework.Application.Api.Web.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            ApplicationUser user = new ApplicationUser() { UserName = model.Email, EmailAddress = model.Email};
